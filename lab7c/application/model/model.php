...
class Model {
    ...
    public function dbInsertData()
    {
        try {
            ...
            $this->dbhandle->exec(
                "INSERT INTO Model_3D (Id,x3dModelTitle,x3dCreationMethod,modelTitle,modelSubtitle,modelDescription) VALUES (2,'string_1','string_2','string_3','string_4','string_5');"
            );
            $this->dbhandle->exec(
                "INSERT INTO Model_3D (Id,x3dModelTitle,x3dCreationMethod,modelTitle,modelSubtitle,modelDescription) VALUES (3,'string_1','string_2','string_3','string_4','string_5');"
            );
